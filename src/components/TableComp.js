...
export default function TableComp (){
    ...
    return(
        <>
            ...
            ) : <div className="my-10 text-xl">Loading..</div>
            }
            <div className="flex items-center justify-between capitalize mb-4">
                <span>Data provided by <a className='text-green font-semibold' href='https://www.coingecko.com' rel='noopener noreferrer' target='_blank'>CoinGecko</a></span>
                <Pagination />
            </div>
        </>
    )
